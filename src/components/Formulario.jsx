...
function Formulario() {
  ...
  const categoriasSubcategorias = {
    ...
    "Computadoras y laptops": ["Laptops", "Computadoras", "Otras"],
  ...
  return (
    ...
    >
      {/* Pregunta 0 */}
      <div className="mb-6">
        <h2 className="text-xl font-semibold mb-4">Ingrese su edad</h2>
        <input
      ...
      <div className="mb-6">
        ...
        <div className="space-y-3">
          {["Nunca", "Raramente", "Ocasionalmente", "Frecuente", "Siempre"].map(
            (option) => (
          ...
          {[
            ...
            <div key={option} className="flex items-center space-x-3">
              <input
                ...
                className="h-4 w-4 text-indigo-600 border-gray-300 focus:ring-indigo-500"
              />
              <label htmlFor={`visualizar-${index}`} className="text-gray-700">
                {option}
              </label>
            </div>
          ))}
      ...
      <div className="mb-6">
        ...
        <p className="text-sm mb-4">
          Comparar productos le permite evaluar opciones para tomar una decisión
          más informada.
        </p>
